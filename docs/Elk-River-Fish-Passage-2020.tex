...
\begin{verbatim}
## Reading layer `hab_wshds_ltree' from data source `C:\Users\allan\OneDrive\New_Graph\Current\2020-025_cwf_elk\scripts\fish_passage_elk_2020_reporting\data\fishpass_mapping.gpkg' using driver `GPKG'
## Simple feature collection with 7 features and 2 fields
## geometry type:  POLYGON
## dimension:      XY
## bbox:           xmin: 1778770 ymin: 541240.2 xmax: 1806472 ymax: 631526.5
## projected CRS:  NAD83 / BC Albers
## Reading layer `hab_wshds_ltree_up1' from data source `C:\Users\allan\OneDrive\New_Graph\Current\2020-025_cwf_elk\scripts\fish_passage_elk_2020_reporting\data\fishpass_mapping.gpkg' using driver `GPKG'
...
\caption{\label{tab:unnamed-chunk-4}Summary of Phase 2 fish passage assessments.}
\centering
\fontsize{11}{13}\selectfont
...
\begin{figure}
\centering
\includegraphics{Elk-River-Fish-Passage-2020_files/figure-latex/plot-fish-box-010-1.pdf}
\caption{\label{fig:plot-fish-box-010}Fish densities (fish/100m2) for PSCIS crossing 50155.}
\end{figure}

\begin{figure}
\centering
\includegraphics{Elk-River-Fish-Passage-2020_files/figure-latex/photo-001-1.pdf}
\caption{\label{fig:photo-001}Typical habitat downstream of PSCIS crossing 50155.}
\end{figure}

\begin{figure}
\centering
\includegraphics{Elk-River-Fish-Passage-2020_files/figure-latex/photo-002-1.pdf}
