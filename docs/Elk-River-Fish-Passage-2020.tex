...
html\_title \textless- paste0(`\#\#\# Crossing', my\_site, ' - `, my\_overview\_info \%\textgreater\% pull(road\_name),' - ', my\_overview\_info \%\textgreater\% pull(stream\_name))
...
\textbackslash caption\{(\#tab:cost\_est)Modelled upstream habitat estimate and cost benefit.\}
\centering
\fontsize{11}{13}\selectfont
