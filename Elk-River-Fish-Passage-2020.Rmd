...
Crossing `r as.character(my_site)` is located on an `r my_pscis_info() %>% pull(stream_name)` `r my_bcfishpass() %>% pull(downstream_route_measure)`m upstream from the confluence with Lizard Creek. 
